...
from nba2k26_editor import launch_editor


def test_run_child_full_editor_if_requested_routes_arguments(monkeypatch) -> None:
    calls: list[list[str]] = []
    module = types.ModuleType("nba2k26_editor.entrypoints.full_editor")
    module.main = lambda args=None: calls.append(list(args or []))  # type: ignore[attr-defined]
    monkeypatch.setitem(sys.modules, "nba2k26_editor.entrypoints.full_editor", module)
